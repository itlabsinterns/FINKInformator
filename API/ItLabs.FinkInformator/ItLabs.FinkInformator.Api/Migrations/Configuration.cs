...
namespace ItLabs.FinkInformator.Api.Migrations
{
    internal sealed class Configuration : DbMigrationsConfiguration<SchoolContext>
    {
        ...
        protected override void Seed(SchoolContext context)
        {
            ...
            //AddCoursePrerequisite(context, 165, 161);
            //AddCoursePrerequisite(context, 166, 160);
            //AddCoursePrerequisite(context, 169, 162);
            //AddCoursePrerequisite(context, 170, 168);
            //AddCoursePrerequisite(context, 171, 160);
            //AddCoursePrerequisite(context, 171, 165);
            //AddCoursePrerequisite(context, 181, 162);
            //AddCoursePrerequisite(context, 181, 167);
            //AddCoursePrerequisite(context, 182, 161);
            //AddCoursePrerequisite(context, 183, 167);
            //AddCoursePrerequisite(context, 184, 167);
            //AddCoursePrerequisite(context, 185, 160);
            //AddCoursePrerequisite(context, 172, 168);
            //AddCoursePrerequisite(context, 174, 162);
            //AddCoursePrerequisite(context, 174, 167);
            //AddCoursePrerequisite(context, 187, 171);
            //AddCoursePrerequisite(context, 188, 167);
            //AddCoursePrerequisite(context, 189, 169);
            //AddCoursePrerequisite(context, 190, 168);
            //AddCoursePrerequisite(context, 191, 160);
            //AddCoursePrerequisite(context, 193, 171);
            //AddCoursePrerequisite(context, 176, 168);
            //AddCoursePrerequisite(context, 177, 169);
            //AddCoursePrerequisite(context, 177, 167);
            //AddCoursePrerequisite(context, 199, 168);
            //AddCoursePrerequisite(context, 200, 169);
            //AddCoursePrerequisite(context, 201, 167);
            //AddCoursePrerequisite(context, 203, 169);
            //AddCoursePrerequisite(context, 203, 170);
            //AddCoursePrerequisite(context, 204, 174);
            //AddCoursePrerequisite(context, 205, 195);
            //AddCoursePrerequisite(context, 206, 174);
            //AddCoursePrerequisite(context, 207, 173);
            //AddCoursePrerequisite(context, 208, 165);
            //AddCoursePrerequisite(context, 210, 167);
            //AddCoursePrerequisite(context, 209, 170);
            //AddCoursePrerequisite(context, 209, 172);
            //AddCoursePrerequisite(context, 211, 169);
            //AddCoursePrerequisite(context, 212, 172);
            //AddCoursePrerequisite(context, 213, 166);
            //AddCoursePrerequisite(context, 214, 174);
            //AddCoursePrerequisite(context, 217, 190);
            //AddCoursePrerequisite(context, 218, 173);
            //AddCoursePrerequisite(context, 220, 177);
            //AddCoursePrerequisite(context, 225, 167);
            //AddCoursePrerequisite(context, 226, 168);
            //AddCoursePrerequisite(context, 227, 169);
            //AddCoursePrerequisite(context, 227, 177);
            //AddCoursePrerequisite(context, 228, 184);
            //AddCoursePrerequisite(context, 231, 165);
            //AddCoursePrerequisite(context, 232, 165);
            //AddCoursePrerequisite(context, 233, 175);
            //AddCoursePrerequisite(context, 234, 172);
            //AddCoursePrerequisite(context, 235, 171);
            //AddCoursePrerequisite(context, 236, 173);
            //AddCoursePrerequisite(context, 237, 177);
            //AddCoursePrerequisite(context, 238, 170);
            //AddCoursePrerequisite(context, 238, 200);
            //AddCoursePrerequisite(context, 241, 173);
            //AddCoursePrerequisite(context, 242, 197);
            //AddCoursePrerequisite(context, 244, 171);
            //AddCoursePrerequisite(context, 245, 192);
            //AddCoursePrerequisite(context, 246, 233);
            //AddCoursePrerequisite(context, 246, 175);
            //AddCoursePrerequisite(context, 250, 209);
            //AddCoursePrerequisite(context, 250, 170);
            //AddCoursePrerequisite(context, 251, 184);
            //AddCoursePrerequisite(context, 252, 177);
            //AddCoursePrerequisite(context, 279, 163);
            //AddCoursePrerequisite(context, 283, 175);
            //AddCoursePrerequisite(context, 284, 175);
            //AddCoursePrerequisite(context, 288, 177);
            //AddCoursePrerequisite(context, 290, 167);
            //AddCoursePrerequisite(context, 258, 160);
            //AddCoursePrerequisite(context, 259, 167);
            //AddCoursePrerequisite(context, 263, 170);
            //AddCoursePrerequisite(context, 257, 170);
            //AddCoursePrerequisite(context, 266, 170);
            //AddCoursePrerequisite(context, 226, 257);
            //AddCoursePrerequisite(context, 291, 170);
            //AddCoursePrerequisite(context, 269, 170);
            //AddCoursePrerequisite(context, 262, 192);
            //AddCoursePrerequisite(context, 261, 173);
            //AddCoursePrerequisite(context, 221, 173);
            //AddCoursePrerequisite(context, 260, 168);
            //AddCoursePrerequisite(context, 267, 266);
            //AddCoursePrerequisite(context, 267, 170);
            //AddCoursePrerequisite(context, 268, 170);
            //AddCoursePrerequisite(context, 271, 166);
            //AddCoursePrerequisite(context, 272, 172);
            //AddCoursePrerequisite(context, 272, 170);
            //AddCoursePrerequisite(context, 273, 170);
            //AddCoursePrerequisite(context, 277, 170);
            //AddCoursePrerequisite(context, 276, 170);
            //AddCoursePrerequisite(context, 276, 170);
            //AddCoursePrerequisite(context, 292, 170);
